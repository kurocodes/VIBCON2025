...
const linkStyle = "w-fit hover:text-[var(--color-accent)] hover:max-lg:-translate-y-1 hover:lg:translate-x-2 transition-all duration-300";
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-3 lg:gap-20 px-4 sm:px-10 md:px-30 mb-10">
        <div className="text-start">
          ...
          <p className="text-sm">
            ...
            Veterinary Immunology & Biotechnology (ISVIB)</b>, hosted at the
            <b>tranquil ICAR-IVRI Mukteswar campus</b>. It brings together global
            experts to explore innovations in animal health under the One Health
            vision.
          </p>
        </div>
        ...
        <div className="text-start mt-10">
          ...
          <ul className="mt-2 max-lg:flex max-lg:flex-wrap gap-4">
            <li className={linkStyle}><NavLink to="/">Home</NavLink></li>
            <li className={linkStyle}><NavLink to="/about">About</NavLink></li>
            <li className={linkStyle}><NavLink to="/events">Program & Events</NavLink></li>
            <li className={linkStyle}><NavLink to="/registration">Registration</NavLink></li>
            <li className={linkStyle}><NavLink to="/travel">Travel</NavLink></li>
          </ul>
        </div>
        ...
        <div className="text-start mt-10">
          ...
          <div className="mt-2 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[var(--color-accent)]">isvibcon2025@gmail.com</span></div>
            <div className="flex items-center gap-2">
              <img src={icons.phone_icon} alt="phone_icon" />
              <span className="text-[var(--color-accent)]">05942-286346</span></div>
          </div>
        </div>
      </div>
